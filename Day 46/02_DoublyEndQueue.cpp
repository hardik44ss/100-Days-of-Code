...
public:
    ...
    int popFront()
    {
        ...
        cout<<ans<<" popped from front"<<endl;
        return ans;
    }
    ...
    int popRear()
    {
        ...
        cout<<ans<<" popped from rear"<<endl;
        return ans;
    }
...
{
    Deque dq(5);
    cout << dq.pushFront(1) << endl;
    cout << dq.pushRear(2) << endl;
    cout << dq.pushFront(3) << endl;
    cout << dq.pushRear(4) << endl;
    cout << dq.pushFront(5) << endl;
    cout <<"IS Full : "<<boolalpha<< dq.isFull() << endl;
    cout << dq.pushRear(6) << endl;
